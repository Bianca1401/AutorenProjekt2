...
namespace AutorenProjekt2.Controllers
{
    public class BuchController : Controller
    {
        ...
        public BuchController(AutorenProjekt2Context context)
        {
            _context = context;
        }
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(int id, [Bind("Id,Buchtitel,Klappentext,Preis,Erscheinungsdatum,ISBN,BuchCover")] Buch buch)
        //{
        //    if (id != buch.Id)
        //    {
        //        return NotFound();
